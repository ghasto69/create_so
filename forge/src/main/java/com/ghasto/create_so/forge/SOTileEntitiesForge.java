...
import com.ghasto.create_so.forge.sanding_wheel.CrushingWheelBlockEntity;
import com.ghasto.create_so.forge.sanding_wheel.CrushingWheelControllerBlockEntity;
...
public class SOTileEntitiesForge {
    public static final BlockEntityEntry<CrushingWheelBlockEntity> CRUSHING_WHEEL = REGISTRATE
            ...
            .validBlocks(SOBlocksForge.CRUSHING_WHEEL)
    ...
    public static final BlockEntityEntry<CrushingWheelControllerBlockEntity> CRUSHING_WHEEL_CONTROLLER =
            REGISTRATE
                    ...
                    .validBlocks(SOBlocksForge.CRUSHING_WHEEL_CONTROLLER)
                    // .renderer(() -> renderer)
                    .register();
